...
- **Ingest a PDF document** — parse and extract the content (PDF provided in the repo), ensuring the user can ask a broad range of questions.
...
Once complete, push your code to your personal repo and send the link through.
...
- Backend must be written in Python, C# or TypeScript to comply with Microsoft Agent Framework (+ TypeScript if using OpenAI)
