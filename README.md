...
Write a backend application for the ingestion of documents for downstream tasks such as Q&A, summaries, storage, and more.
...
- **_OPTIONAL EXTRA_** **Provide a simple interface** — this could be a REST API, CLI, or basic web UI. The focus is on functionality rather than polish.
...
- Must be written in Python or C# to comply with Microsoft Agent Framework (+ TypeScript if using OpenAI)
